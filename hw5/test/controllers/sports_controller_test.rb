...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { league: @sport.league, location: @sport.location, name: @sport.name, stadium: @sport.stadium } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { league: @sport.league, location: @sport.location, name: @sport.name, stadium: @sport.stadium } }
